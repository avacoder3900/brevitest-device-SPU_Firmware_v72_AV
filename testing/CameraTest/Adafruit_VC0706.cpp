...
boolean Adafruit_VC0706::setToColor() {
  uint8_t args[] = {0x02, 0x01, 0x01};

  return runCommand(VC0706_COLOR_CTRL, args, sizeof(args), 5);
}

boolean Adafruit_VC0706::setToBlackAndWhite() {
  uint8_t args[] = {0x02, 0x01, 0x02};
